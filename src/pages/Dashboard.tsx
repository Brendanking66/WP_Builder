  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">WordPress Website Builder</h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Automate the creation of professional WordPress websites for small businesses in minutes.
        </p>
      </div>
